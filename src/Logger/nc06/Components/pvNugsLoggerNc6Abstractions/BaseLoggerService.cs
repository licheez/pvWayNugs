...
/// </summary>
public abstract class BaseLoggerService : ILoggerService
{
    ...
    private readonly SeverityEnu _minLevel;
    ...
    /// severity level filtering, and distribution to multiple log writers.
    /// </summary>
    protected BaseLoggerService(SeverityEnu minLevel,
        ...
        int lineNumber = -1)
    {
        ...
        var tasks = new List<Task>(_logWriters.Length);
        foreach (var logWriter in _logWriters)
        {
