...
/// </code>
/// </example>
public class MsSqlLoggerService : BaseLoggerService,
    IMsSqlLoggerService
{
    ...
    /// </code>
    /// </example>
    public MsSqlLoggerService(SeverityEnu minLogLevel,
        IMsSqlLogWriter logWriter) : base(minLogLevel, logWriter)
    {
    ...
    {
        return await _logWriter.PurgeLogsAsync(retainDic);
    }
