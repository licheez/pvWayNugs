# pvNugsLoggerNc6MsSql

A robust Microsoft SQL Server logging implementation for .NET 6+ applications, providing structured, contextual logging with automatic table management, advanced configuration, and comprehensive error handling.
...
## 📦 Installation
```shell
dotnet add package pvNugsLoggerNc6MsSql
```
...
- **pvNugsLoggerNc6MsSql** – SQL Server implementation (this package)
- **pvNugsLoggerNc6Console** – Console logging implementation
- **pvNugsCsProviderNc6** – Connection string provider abstractions
...
Console.WriteLine("Integration testing console for pvNugsLoggerNc6MsSql");
