namespace pvNugsCsProviderNc10Abstractions;
...
public interface IPvNugsCsProvider
{
    ...
    /// <param name="role">The SQL role that determines the access level for the connection string. Defaults to <see cref="CsProviderSqlRoleEnu.Reader"/> if not specified.</param>
