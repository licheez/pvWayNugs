...
/// <summary>
/// Represents a single MsSQL connection configuration row for the PvNugsCsProviderMsSqlConfig.
/// Each row contains all parameters required for a specific database connection and credential management mode.
/// </summary>
public class PvNugsCsProviderMsSqlConfigRow
{
    /// <summary>
    /// Gets or sets the unique name for this configuration row.
    /// Used to identify and reference this connection configuration.
    /// </summary>
    /// <value>The unique name for the configuration row.</value>
