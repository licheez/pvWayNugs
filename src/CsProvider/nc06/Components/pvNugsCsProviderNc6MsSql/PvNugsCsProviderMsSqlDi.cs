...
/// <list type="bullet">
/// <item><description><see cref="IPvNugsStaticSecretManager"/> - Optional service for StaticSecret mode, retrieves passwords from secure storage using static secret names.</description></item>
/// <item><description><see cref="IPvNugsDynamicSecretManager"/> - Optional service for DynamicSecret mode, generates temporary database credentials with automatic expiration and renewal.</description></item>
/// </list>
/// 
...
/// <list type="number">
/// <item><description><c>Config Mode:</c> Only <see cref="IConsoleLoggerService"/> is required. Credentials are read from configuration files.</description></item>
/// <item><description><c>StaticSecret Mode:</c> Requires <see cref="IConsoleLoggerService"/> and <see cref="IPvNugsStaticSecretManager"/>. Passwords are retrieved from secret storage.</description></item>
/// <item><description><c>DynamicSecret Mode:</c> Requires <see cref="IConsoleLoggerService"/> and <see cref="IPvNugsDynamicSecretManager"/>. Uses temporary credentials with automatic renewal.</description></item>
/// </list>
/// 
        ...
        this IServiceCollection services, IConfiguration config)
    {
        ...
        services.Configure<PvNugsCsProviderMsSqlConfig>(configSection =>
        {
            ...
            var configRows = configSection.Rows ?? 
                             new PvNugsCsProviderMsSqlConfigRow[] { };
