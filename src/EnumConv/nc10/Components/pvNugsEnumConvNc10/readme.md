...
A .NET Core 10 utility library that provides enhanced enum conversion capabilities, focusing on `Description` attribute-based conversions and flexible matching strategies.
...
```bash
dotnet add package pvNugsEnumConvNc10
```
## Usage
