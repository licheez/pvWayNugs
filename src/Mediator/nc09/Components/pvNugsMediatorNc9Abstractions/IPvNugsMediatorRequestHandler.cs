...
/// The type of request to be handled. Must implement <see cref="IPvNugsMediatorRequest"/>.
/// </typeparam>
/// <remarks>
/// <para>
/// This is a convenience interface that inherits from 
/// <see cref="IPvNugsMediatorRequestHandler{TRequest, TResponse}"/> with <see cref="Unit"/> 
...
/// from their <see cref="IPvNugsMediatorRequestHandler{TRequest, TResponse}.HandleAsync"/> method.
/// </para>
/// </remarks>
/// <example>
/// <code>
...
/// </summary>
/// <typeparam name="TRequest">
/// The type of request to be handled. Must implement <see cref="IPvNugsMediatorRequest{TResponse}"/>.
/// </typeparam>
...
/// </para>
/// <para>
/// Handlers are automatically discovered and invoked by <see cref="IPvNugsMediator.SendAsync{TResponse}"/>
    ...
    where TRequest : IPvNugsMediatorRequest<TResponse>
{
    ...
    /// It is invoked automatically by the mediator when <see cref="IPvNugsMediator.SendAsync{TResponse}"/>
