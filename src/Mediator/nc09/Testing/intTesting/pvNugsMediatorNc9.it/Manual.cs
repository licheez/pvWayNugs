...
public class Manual(ILoggerService logger)
{
    public async Task RunTestAsync()
    {
        var inMemSettings = new Dictionary<string, string>
        {
            ...
            // MEDIATOR
            { "PvNugsMediatorConfig:DiscoveryMode", "Manual" }
        };
    ...
    private static void RegisterHandlers(ServiceCollection services)
    {
        ...
        services.AddTransient<
            ...
            MdProductQueryHandler>();

        services.AddTransient<
            INotificationHandler<MdNotification>,
            MdMainNotificationHandler>();

        services.AddTransient<
            INotificationHandler<MdNotification>,
            MdAlternateNotificationHandler>();
    }
}