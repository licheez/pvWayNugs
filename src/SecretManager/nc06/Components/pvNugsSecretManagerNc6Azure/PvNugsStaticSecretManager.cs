...
internal class PvNugsStaticSecretManager : IPvNugsStaticSecretManager
{
    /// <summary>
    ...
    /// <seealso cref="PvNugsAzureServicePrincipalCredential"/>
    /// <seealso cref="PvNugsStaticSecretManagerException"/>
    public PvNugsStaticSecretManager(ILoggerService logger,
    ...
    private SecretClient Client
    {
        get
        {
            ...
            {
                _logger.Log("using service principal credential");
            ...
            {
                _logger.LogAsync("using Default Azure Credential");
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            var secretValue = await _cache.GetAsync<string>(cacheKey, cancellationToken);
            ...
            await _cache.SetAsync(cacheKey, secretValue, 
