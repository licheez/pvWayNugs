...
///         { "name", "customer-db" }
///     };
///     var credential = await _secretManager.GetDynamicSecretAsync(parameters);
///     
///     if (credential == null)
...
///             credential = await _secretManager.GetDynamicSecretAsync(parameters);
///         }
///         
...
/// <seealso cref="IPvNugsSecretManager.GetDynamicSecretAsync"/>
public interface IPvNugsDynamicCredential
{
    ...
    /// Implementations should provide a value whose <see cref="DateTime.Kind"/> is <see cref="DateTimeKind.Utc"/>.
    ...
    ///             
        ...
        ///             { "name", secretName }
        ///         };
        ///         var newCredential = await _secretManager.GetDynamicSecretAsync(parameters);
    ///         
