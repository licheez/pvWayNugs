...
public static class SaslPlaintextTest
{
    public static async Task RunAsync()
    {
        var inMemSettings = new Dictionary<string, string>
        {
            ...
            // KAFKA
            { "PvNugsMessagingKafkaConfig:BootstrapServers", "localhost:9094" },
    
            // KAFKA SECURITY
            { "PvNugsMessagingKafkaSecurityConfig:Mode", "SaslPlaintext" },
            { "PvNugsMessagingKafkaSecurityConfig:SaslUsernameParams:secretName", "kafka-username" },
            { "PvNugsMessagingKafkaSecurityConfig:SaslPasswordParams:secretName", "kafka-password" },    
        ...
        const string topicName = "sasl-plaintext-test-topic";
